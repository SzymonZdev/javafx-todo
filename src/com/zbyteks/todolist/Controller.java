...
public class Controller {
    ...
    public void initialize() {
        // Adds the context menu for items
        ...
        // add listener for change (not just mouse click)
        todoListView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<TodoItem>() {
            ...
            public void changed(ObservableValue<? extends TodoItem> observableValue, TodoItem todoItem, TodoItem t1) {
                if (t1 != null) {
                    ...
                    // Using DateTimeFormatter to format the date
        ...
        // Previous populate method, returned unsorted list of items
...
//            todoListView.getItems().setAll(TodoData.getInstance().getTodoItems());
            // This is now handled by data binding
...
//    }
    ...
    public void deleteItem(TodoItem item) {
        ...
        stage.getIcons().add(new Image(Objects.requireNonNull(this.getClass().getResource("/delete-icon.png")).toString()));
        alert.setGraphic(new ImageView(Objects.requireNonNull(this.getClass().getResource("/feedback-icon.png")).toString()));
    ...
    public void showEditItemDialog(TodoItem item) {
        ...
        dialog.setHeaderText("\t Use this dialog to edit your todo item");
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("todoItemDialog.fxml"));
